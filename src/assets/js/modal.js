...
var Modal = function (e) {
  ...
  function d(e, t) {
    return e.nodeName ? e : (e = e.replace(/(\t|\n$)/g, ""), _ || (_ = document.createElement("div")), _.innerHTML = "", _.innerHTML = e, !0 === t ? _.childNodes : _.childNodes[0]);
  }
  function c() {
    var e = void 0,
      t = void 0,
  ...
  var u = function () {
    ...
    k = function (e) {
      function t() {
        ...
        if (n.id = a(), n.el = null, n._html = {}, n._events = {}, n._visible = !1, n._pointerInContent = !1, n._options = v({}, t.options, e), n._templates = v({}, t.templates, e.templates || {}), n._html.appendTo = document.querySelector(n._options.appendTo), n._scrollbarWidth = c(), null === n._options.buttons && (n._options.buttons = t.buttons.dialog), n._options.el) {
          var s = n._options.el;
      ...
      return s(t, e), u(t, null, [{
        ...
        value: function value() {
          ...
          this._events.keydownHandler = this._handleKeydownEvent.bind(this), document.body.addEventListener("keydown", this._events.keydownHandler), this._events.mousedownHandler = this._handleMousedownEvent.bind(this), e.container.addEventListener("mousedown", this._events.mousedownHandler), this._events.clickHandler = this._handleClickEvent.bind(this), e.container.addEventListener("click", this._events.clickHandler), this._events.resizeHandler = this._handleResizeEvent.bind(this), window.addEventListener("resize", this._events.resizeHandler);
        }
      }, {
        key: "_handleMousedownEvent",
        value: function value(e) {
          var t = this;
          this._pointerInContent = !1, h(e.target).every(function (e) {
            return !e.classList || !e.classList.contains("modal-content") || (t._pointerInContent = !0, !1);
          });
        }
      }, {
        ...
        value: function value(e) {
          ...
          h(e.target).every(function (n) {
            return !("HTML" === n.tagName || !0 !== t._options.backdrop && n.classList.contains("modal") || n.classList.contains("modal-content") || ("modal" === n.getAttribute("data-dismiss") ? (t.emit("dismiss", t, e, l(e.target, "button")), t.hide(), 1) : !t._pointerInContent && n.classList.contains("modal") && (t.emit("dismiss", t, e, null), t.hide(), 1)));
        ...
        value: function value() {
          var e = this,
            t = this._options,
            n = this._html;
          return this.emit("show", this), this._checkScrollbar(), this._setScrollbar(), document.body.classList.add("modal-open"), t.construct && n.appendTo.appendChild(n.container), n.container.style.display = "flex", n.container.scrollTop = 0, !1 !== t.backdrop ? (this.once("showBackdrop", function () {
        ...
        key: "_removeEvents",
        value: function value() {
          this._events.keydownHandler && document.body.removeEventListener("keydown", this._events.keydownHandler), this._html.container.removeEventListener("mousedown", this._events.mousedownHandler), this._html.container.removeEventListener("click", this._events.clickHandler), window.removeEventListener("resize", this._events.resizeHandler);
        }
      }, {
        key: "_checkScrollbar",
        value: function value() {
  ...
  e.exports = n, n.EventEmitter = n, n.prototype._events = void 0, n.prototype._maxListeners = void 0, n.defaultMaxListeners = 10, n.prototype.setMaxListeners = function (e) {
    ...
    } else if (s(n)) for (a = Array.prototype.slice.call(arguments, 1), d = n.slice(), o = d.length, l = 0; l < o; l++) d[l].apply(this, a);
    return !0;
    ...
    if (n = this._events[e], r = n.length, o = -1, n === t || i(n.listener) && n.listener === t) delete this._events[e], this._events.removeListener && this.emit("removeListener", e, t);else if (s(n)) {
      for (a = r; a-- > 0;) if (n[a] === t || n[a].listener && n[a].listener === t) {
        o = a;
        break;
      }
      if (o < 0) return this;
